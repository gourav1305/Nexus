...
for (const [code, name] of Object.entries(LANG_MAP))
    REVERSE_MAP[name.toLowerCase()] = code;
...
- Preserve the original tone and meaning.`;
    ...
    const result = await modelRouter.routeQuery({ provider: 'groq', model: 'llama-3.1-8b-instant', autoRoute: false }, messages, { preferredProvider: 'groq', preferredModel: 'llama-3.1-8b-instant', autoRoute: false, temperature: 0.01 });
